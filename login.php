...
<nav class="navbar navbar-default navbar-fixed-top">
            ...
            <div class="collapse navbar-collapse" id="resNav" style="margin-right: 50px; margin-top: 5px;">
              ...
              <li class=""><a href="aboutus.php" style="margin-top: 6px;">Tentang Kami</a></li>
				...
				<li><a href="main.php" style="margin-top: 6px;">Kembali</a></li>
              </ul>
            </div>
          </nav>
...
<!--===============================================================================================-->
  ...
  <div>
  <img src="img/koperasi.png" width="20%" style="margin-top: -600px; margin-left: 300px;">
  <h1 style="font-family: Times New Roman; margin-top: -280px; text-align: left; font-weight: bold; color: #607782; margin-left: 250px;">KOPERASI PADASUKA</h1>
  </div>         
